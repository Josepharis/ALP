...
final List<Question> analgesicAgentsQuestions = [
  ...
  Question(
    ...
    correctAnswerIndex: 2,
    explanation:
        "Nalbufin, kappa reseptör agonisti ve mu reseptör antagonistidir (agonist-antagonist opioid).",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    options: [
      ...
      "Daha az histamin salınımı",
      "Daha fazla sedasyon",
      "Oral biyoyararlanımının yüksek olması",
      "Daha az solunum depresyonu",
    ],
    correctAnswerIndex: 1,
    explanation:
        "Fentanil, morfine göre daha potent, daha lipofilik ve daha az histamin salınımı yapar (daha az hipotansiyon).",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    options: [
      ...
      "Voltaj bağımlı kalsiyum kanallarını inhibe etme",
      "Dopamin geri alım inhibisyonu",
      "Muskarinik reseptör agonizması",
      "GABA-B reseptör aktivasyonu",
    ],
    correctAnswerIndex: 1,
    explanation:
        "Gabapentin/pregabalin, alfa-2-delta alt birimine bağlanarak voltaj bağımlı kalsiyum kanallarını inhibe eder.",
    category: "analjezik ajanlar",
    difficulty: 3,
  ),
  ...
  Question(
    ...
    options: [
      "Dopamin geri alım inhibisyonu",
      "Noradrenalin ve serotonin geri alım inhibisyonu",
      "NMDA reseptör blokajı",
    ...
    correctAnswerIndex: 1,
    explanation:
        "Duloksetin, SNRI grubundadır (nöropatik ağrı ve depresyonda kullanılır).",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    correctAnswerIndex: 3,
    explanation:
        "COX-2 selektif NSAİİ'ler: Celecoxib, etoricoxib. Diğerleri (ibuprofen, naproksen, diklofenak, aspirin) non-selektif COX inhibitörleridir.",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    correctAnswerIndex: 2,
    explanation:
        "Asetaminofen toksisitesi karaciğer nekrozuna yol açar. N-asetilsistein, glutatyon replasmanı yaparak detoksifikasyon sağlar.",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    options: [
      "Maksimum 5 gün kullanılmalıdır",
      "Postoperatif ağrıda parenteral kullanılabilir",
      "COX-1 inhibisyonu yapar",
      "Gebelikte güvenle kullanılabilir",
      "Böbrek yetmezliğinde kontrendikedir",
    ],
    correctAnswerIndex: 3,
    explanation:
        "Ketorolak, gebelikte (3. trimester) kontrendikedir (fetal duktus arteriozusun erken kapanmasına neden olabilir).",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    options: [
      "Akut ağrıda ilk tercihtir",
      "Etkisi 5 dakikada başlar",
      "Termal uyaranlarla salınımı artar",
      "Böbrek yetmezliğinde doz ayarı gerekmez",
      "48 saatte bir uygulanır",
    ],
    correctAnswerIndex: 2,
    explanation:
        "Transdermal fentanil, ısı artışıyla sistemik emilimi artar (sıcak banyo, ateş). Kronik ağrıda kullanılır, etkisi 12-24 saatte başlar, 72 saatte bir değiştirilir.",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    options: [
      "COX-2 selektif inhibisyon yapar",
      "Agranülositoz riski taşır",
      "Gebelikte güvenle kullanılabilir",
      "Astım atağını tetiklemez",
      "Kardiyoprotektif etkisi vardır",
    ],
    correctAnswerIndex: 1,
    explanation:
        "Metamizol, agranülositoz ve alerjik reaksiyon riski nedeniyle birçok ülkede kısıtlıdır.",
    category: "analjezik ajanlar",
    difficulty: 2,
  ),
  ...
  Question(
    ...
    options: [
      "Tam mu reseptör agonistidir",
      "Yüksek dozda solunum depresyonu plato yapar",
      "Oral biyoyararlanımı %90'dır",
      "Naloksonla tamamen antagonize edilebilir",
      "Opioid yoksunluk semptomlarını şiddetlendirir",
    ],
    correctAnswerIndex: 1,
    explanation:
        "Buprenorfin, parsiyel mu agonisti ve kappa antagonistidir. Yüksek dozda solunum depresyonu plato yapar (tam agonistlerde dozla artar).",
    category: "analjezik ajanlar",
    difficulty: 3,
  ),
  ...
  Question(
    ...
    options: [
      "Saf mu agonizması",
      "Mu agonizması + Noradrenalin geri alım inhibisyonu",
      "NMDA antagonizması + Serotonin geri alım inhibisyonu",
      "GABA-A agonizması",
      "Alfa-2 agonizması",
    ],
    correctAnswerIndex: 1,
    explanation:
        "Tapentadol, mu agonisti + noradrenalin geri alım inhibitörü dual etkilidir.",
    category: "analjezik ajanlar",
    difficulty: 3,
  ),
];
