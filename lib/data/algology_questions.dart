...
final List<Question> algologyQuestions = <Question>[
  Question(
    question:
  ...
  Question(
    question:
        "Aşağıdaki ağrı iletim yollarından hangisi ağrının hızlı, keskin ve lokalize iletiminden sorumludur?",
    options: [
      "Spinotalamik yol (lateral)",
      "Spino-retiküler yol",
      "Spino-talamik yol (anterior)",
      "Dorsal kolon-medial lemniskal yol",
      "Kortikospinal yol",
    ],
    correctAnswerIndex: 0,
    explanation:
        "Lateral spinotalamik yol keskin ve lokalize ağrının iletiminde görevlidir.",
    category: "Algoloji",
    difficulty: 2,
  ),
  Question(
    question:
        "Ağrının algılanmasında periferik reseptörlerin uyarılması sonucu aşağıdaki iyonlardan hangisinin artışı en çok ağrı iletimini başlatır?",
    options: [
      "Sodyum (Na⁺)",
      "Potasyum (K⁺)",
      "Kalsiyum (Ca²⁺)",
    ...
    correctAnswerIndex: 0,
    explanation:
        "Sodyum iyonlarının sinir hücresine girişi aksiyon potansiyelini başlatır.",
    category: "Algoloji",
    difficulty: 2,
  ),
  Question(
    question:
        "Ağrı modülasyonunda \"endojen opioid sistem\"in en önemli etkisi aşağıdakilerden hangisidir?",
    options: [
      "Ağrı iletimini inhibe etmek",
      "Sinir büyümesini artırmak",
      "İnflamasyonu artırmak",
      "Periferik sensitizasyonu artırmak",
      "Sinir iletim hızını artırmak",
    ],
    correctAnswerIndex: 0,
    explanation:
        "Endojen opioidler ağrı yolunu inhibe eder ve analjezik etki sağlar.",
    category: "Algoloji",
    difficulty: 2,
  ),
  Question(
    question:
        "Aşağıdakilerden hangisi ağrı reseptörlerinin (noksiseptörlerin) en belirgin özelliğidir?",
    options: [
      "Ağrısal uyarıcıya spesifik olması",
      "Tüm uyarıcılara yanıt vermesi",
      "Hızlı adaptasyon göstermesi",
      "Merkezi sinir sisteminde bulunması",
      "Miyelinli liflerden oluşması",
    ],
    correctAnswerIndex: 0,
    explanation:
        "Noksiseptörler ağrısal uyarıcılara spesifiktir.",
    category: "Algoloji",
    difficulty: 2,
  ),
  Question(
