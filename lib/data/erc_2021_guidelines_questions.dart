...
List<Question> erc2021GuidelinesQuestions = [
  ...
  Question(
    id: 'erc_016',
    question: 'ERC\'ye göre solunum durması olan çocukta yapılacak ilk müdahale nedir?',
    options: [
      '5 başlangıç kurtarıcı solunum',
    ...
    explanation: 'Pediatrik arrestte genellikle solunumsaldır → 5 kurtarıcı solukla başlanmalıdır.',
    category: 'ERC 2021 Guidelines',
    difficulty: 2
  ),
  Question(
  ...
  Question(
    id: 'erc_018',
    question: 'ERC 2021\'e göre CPR sırasında hastaya oksijen verilmesi gerekiyorsa hangi yol tercih edilmelidir?',
    options: [
      'Nazal kanül',
      'Yüz maskesi',
      'Basit oksijen maskesi',
      'Balon-valf maske + %100 O₂',
      'Nebülizatör sistemi'
    ],
    correctAnswerIndex: 3,
    explanation: 'En etkili oksijen desteği balon-valf maskesiyle %100 O₂ verilerek sağlanır.',
    category: 'ERC 2021 Guidelines',
    difficulty: 2
  ),
  Question(
    id: 'erc_019',
    question: 'Kardiyak arrestte "H\'s and T\'s" olarak bilinen geri döndürülebilir nedenlerden biri aşağıdakilerden hangisidir?',
    options: [
      'Hiperkalsemi',
      'Hipotermi',
      'Hiperkolesterolemi',
    ...
    correctAnswerIndex: 1,
    explanation: '"H\'s and T\'s" arasında: hipovolemi, hipoksi, H+ (asidoz), hipo/hiperkalemi, hipotermi gibi durumlar yer alır.',
    category: 'ERC 2021 Guidelines',
    difficulty: 2
  ),
  Question(
    id: 'erc_020',
    question: 'ERC\'ye göre CPR sırasında en iyi sonuç için kompresyon ve gevşeme oranı nasıl olmalıdır?',
    options: [
  ...
  Question(
    id: 'erc_027',
    question: 'ERC kılavuzuna göre CPR kalitesini en iyi değerlendiren cihaz hangisidir?',
    options: [
      'OED',
      'Puls oksimetre',
      'Kapnograf',
    ...
    correctAnswerIndex: 2,
    explanation: 'Kapnografi CPR etkinliğini izlemek için en iyi göstergedir.',
    category: 'ERC 2021 Guidelines',
    difficulty: 2
  ),
  Question(
    id: 'erc_028',
    question: 'Aşağıdakilerden hangisi ROSC sonrası nörolojik iyileşme için en önemli faktördür?',
    options: [
      'Adrenalin dozu',
      'OED sayısı',
      'Erken hipotermi protokolü',
      'Erken fizik tedavi',
      'İlk yardım çantası içeriği'
    ],
    correctAnswerIndex: 2,
    explanation: 'Hedef sıcaklık kontrolü, nörolojik hasarı azaltmak için önerilir.',
    category: 'ERC 2021 Guidelines',
    difficulty: 2
  ),
  Question(
