...
class UserService {
  ...
  Future<List<Map<String, dynamic>>> getUserActivities({int limit = 5}) async {
    try {
      final userId = _authService.currentUser?.uid;
      if (userId == null) {
        throw Exception('Kullanıcı giriş yapmamış');
      ...
      print('Kullanıcı aktivitelerini getirme hatası: $e');
      return [];
    }
  }
  ...
  Future<bool> addActivity({
    ...
    try {
      ...
      print('Aktivite ekleme hatası: $e');
      return false;
    }
  }
}
